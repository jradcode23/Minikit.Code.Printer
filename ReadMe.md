...
## Required software
- An unmodified copy of the Steam release of Lego Pirates of the Caribbean
...
- The Lego Pirates of the Caribbean Minikit Code Printer Mod [Link](https://github.com/jradcode23/Minikit.Code.Printer)
- --
...
- Add Lego Pirates of the Caribbean to Reloaded II either through setup or by clicking the + on the left.
...
- If you are using the Steam version, we will need to use the ASI loader (optional for GOG version) 
  - Under Lego Pirates of the Caribbean, click Edit Application
